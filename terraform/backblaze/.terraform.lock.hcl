...
provider "registry.terraform.io/dark-vex/b2" {
  version     = "0.14.0-fix.1"
  constraints = "0.14.0-fix.1"
  hashes = [
    "h1:7D5Wp+6Uv2Jdb3MEIw/kOlm4bt27pYZRI5ZT1uMegD0=",
    "h1:8K++WqEQxuzm6xTMVCxeyplWmA7OXshWWvvVXLzZT9U=",
  ]
}
